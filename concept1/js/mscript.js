$(function() {
    ...
    // first 4 imiges added
    $listItems.each(function() {
        $(this).append($("#img_container img:first"));
        });
				...
				rotateImages		= function(dir) {
					...
					$listItems.each(function(i) {
						...
						setTimeout(function() {
                                ...
                                // other - naujas img is saraso
                                // img esamas kuris grazinamas i sarasa
								$img				= $item.children('img:last');
								
								//the next image to show and its initial rotation (depends on dir)
                                if (dir === 1){
                                    otherRotation = '-30deg';
                                    $other = $("#img_container img:first");
                                    rotateTo = '80deg'
                                } 
                                else{
									otherRotation = '30deg';
                                    rotateTo = '-80deg'
                                    $other = $("#img_container img:last");
